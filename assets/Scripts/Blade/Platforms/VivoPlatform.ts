...
export default class VivoPlatform extends PlatformBase {
    ...
    private _configs: VivoConfigBase = null;

    protected onInitialize() {
        this._configs = PlatformConfig[PlatformService.PlatformType.VIVO];
    ...
    */
    ...
    public isSupportRewardVideo(): boolean {
        return qg.getSystemInfoSync().platformVersionCode >= 1041
    }
    ...
    */
    public isSupportBanner(): boolean {
        return qg.getSystemInfoSync().platformVersionCode >= 1031
    }
...
import VivoConfigBase from "../../Module/Defines/PlatformConfig/Bases/HuaWeiConfigBase";
