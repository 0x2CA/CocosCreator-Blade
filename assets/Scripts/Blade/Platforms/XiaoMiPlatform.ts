...
export default class XiaoMiPlatform extends PlatformBase {
    ...
    private _appAccountId: number = -1;
    private _session: string = "";

    private _configs: XiaoMiConfigBase = null;

    protected onInitialize() {
        this._configs = PlatformConfig[PlatformService.PlatformType.XIAOMI];
    ...
    public setAppAccountId(appAccountId: number) {
        this._appAccountId = appAccountId;
    }
...
import XiaoMiConfigBase from "../../Module/Defines/PlatformConfig/Bases/XiaoMiConfigBase";
