...
var i = t("../../Helpers/HttpHelper"), a = t("../../../Blade/Services/PlatformService"), s = function() {
function t() {}
...
case 1:
if ((e = o.sent()) && e.token) return [ 2, n(e) ];
throw new Error();
...
var r = n.split(".")[0].split(","), o = r.length;
o > 1 && (n = r[0] + "." + r[1].substring(0, 2));
...
var r = n.split("."), o = r[0].split(","), i = o.length;
o[0] = (parseInt(o[0]) + 1e3 + "").substr(1);
o.push(r[1]);
var a = (Math.floor(i / e) + Math.pow(10, (Math.floor(64 / e) + "").length) + "").substr(1), s = (parseInt(o.join("").substr(0, 3 * e - 1)) + Math.pow(10, 3 * e - 1) + "").substr(1);
return parseInt(a + s);
} catch (t) {
console.log(t);
return 0;
...
e.ticker = h.default.instance;
e.timer = g.default.instance;
e.popup = d.default.instance;
...
var o = t("../../Blade/Decorators/Service"), i = t("../../Blade/Decorators/Singleton"), a = t("./TimerService"), s = function() {
function t() {}
t.prototype.initialize = function() {};
t.prototype.lazyInitialize = function() {};
...
var o;
(o = new t()).exec.apply(o, e);
n();
});
};
return t = r([ i.default, o.default("CommandService") ], t);
}();
n.default = s;
cc._RF.pop();
}, {
...
var e, n = t.keys, r = t.data, o = t.index;
if (null == o) {
e = [];
for (var i = 0; i < r.length; i++) {
for (var a = r[i], s = {}, c = 0; c < a.length; c++) s[n[c]] = a[c];
e.push(s);
}
} else {
e = {};
...
a = r[i];
var u = {};
for (c = 0; c < a.length; c++) n[c] != o ? u[n[c]] = a[c] : e[a[c]] = u;
}
}
return e;
};
...
var r = Array(t), o = 0;
for (e = 0; e < n; e++) for (var i = arguments[e], a = 0, s = i.length; a < s; a++, 
o++) r[o] = i[a];
return r;
};
Object.defineProperty(n, "__esModule", {
...
var i = t("../../Blade/Decorators/Service"), a = t("../../Blade/Decorators/Singleton"), s = function() {
function t() {}
t.prototype.initialize = function() {
this.list = new Map();
};
...
var i = this.getController(t);
if (null != i) return i.order.apply(i, o([ e ], n));
console.error("控制器（" + t + "）不存在");
};
return t = r([ a.default, i.default("ControllerService") ], t);
}();
n.default = s;
cc._RF.pop();
}, {
...
return -t * Math.pow(2, 10 * (r -= 1)) * Math.sin((r - o) * n / e);
};
};
...
if (0 == r || 1 == r) return r;
var o = e / n * Math.asin(1 / t);
return t * Math.pow(2, -10 * r) * Math.sin((r - o) * n / e) + 1;
};
};
...
return function(r) {
var o = e / n * Math.asin(1 / t);
return (r *= 2) < 1 ? t * Math.pow(2, 10 * (r -= 1)) * Math.sin((r - o) * n / e) * -.5 : t * Math.pow(2, -10 * (r -= 1)) * Math.sin((r - o) * n / e) * .5 + 1;
};
};
...
case 1:
return [ 4, o.apply(r, [ (a.image = i.sent(), a.text = e, a.data = n, a) ]) ];
...
return e = o([ s.default("GameModel"), i("design:paramtypes", [ Object ]) ], e);
}(a.default);
n.default = c;
cc._RF.pop();
}, {
...
var r = t("../../Blade/Services/PlatformService"), o = function() {
function t() {}
...
success: function(t) {
return 200 == t.statusCode ? o(t.data) : i({
status: t.statusCode,
errMsg: t.errMsg
});
},
...
for (var e, n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
if ("function" == typeof this[t]) return (e = this[t]).call.apply(e, o([ this ], n));
...
for (var e, n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
return "function" == typeof this[t] ? (e = this[t]).call.apply(e, o([ this ], n)) : null;
};
...
type: cc.Button,
tooltip: "确认按钮"
}), i("design:type", "function" == typeof (u = "undefined" != typeof cc && cc.Button) ? u : Object) ], e.prototype, "buttonConfirm", void 0);
o([ f({
type: cc.Button,
tooltip: "取消按钮"
}), i("design:type", "function" == typeof (p = "undefined" != typeof cc && cc.Button) ? p : Object) ], e.prototype, "buttonCancel", void 0);
return e = n = o([ l ], e);
}(cc.Component);
(function(t) {
(function(t) {
...
var n = this, r = [];
this.content.children.forEach(function(o) {
if (o._tag < t || o._tag > e) {
r.push(o);
delete n._filledIds[o._tag];
}
});
return r;
};
...
var e = this, n = t, r = n + this._itemsVisible + (this.spawnCount || 2), o = this.adapter.getCount();
if (!(n >= o)) {
if (r > o) {
r = o;
...
for (var i = 0, a = this.findUpdateIndex(n, r); i < a.length; i++) {
var s = a[i], c = this.adapter._getView(this._items.get() || cc.instantiate(this.itemTemplate), s);
...
var n, a;
o([ c(cc.Prefab), i("design:type", "function" == typeof (a = "undefined" != typeof cc && cc.Prefab) ? a : Object) ], e.prototype, "itemTemplate", void 0);
o([ c, i("design:type", Number) ], e.prototype, "spacing", void 0);
o([ c, i("design:type", Number) ], e.prototype, "spawnCount", void 0);
return e = n = o([ s, u("UI 组件/ListView"), l, f(cc.ScrollView) ], e);
}(cc.Component);
(function(t) {
var e = function() {
function t() {
...
var c = t("../../Blade/Interfaces/IView"), u = t("../../Blade/Libs/ArchiveServerSDK/ArchiveServerSDK"), l = cc._decorator, f = l.ccclass, p = l.property, h = function(t) {
r(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.progress = null;
...
cc.director.preloadScene(t, function(t, r, o) {
...
type: cc.ProgressBar,
tooltip: "加载进度"
}), i("design:type", "function" == typeof (n = "undefined" != typeof cc && cc.ProgressBar) ? n : Object) ], e.prototype, "progress", void 0);
o([ p({
type: cc.Label,
tooltip: "加载状态标签"
}), i("design:type", "function" == typeof (c = "undefined" != typeof cc && cc.Label) ? c : Object) ], e.prototype, "labelStatus", void 0);
return e = o([ f ], e);
}(c.default);
n.default = h;
cc._RF.pop();
...
var s = t("../../Services/LocalizedService"), c = cc._decorator, u = c.ccclass, l = c.property, f = c.executeInEditMode, p = c.menu, h = c.requireComponent, d = c.executionOrder, v = function(t) {
r(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e._langID = "";
...
o([ l, i("design:type", String) ], e.prototype, "_langID", void 0);
o([ l, i("design:type", String), i("design:paramtypes", [ String ]) ], e.prototype, "langID", null);
o([ l({
type: cc.Enum({
Normal: 0,
Upper: 1,
...
tooltip: "文本类型:\n1.正常\n2.全大写\n3.全小写"
}), i("design:type", Object) ], e.prototype, "textType", void 0);
o([ l({
type: [ cc.String ],
tooltip: "格式化参数填充内容"
}), i("design:type", Array) ], e.prototype, "langArgs", void 0);
return e = o([ u, f, h(cc.Label), d(999), p("Localized/LocalizedLabel") ], e);
}(cc.Component);
n.default = v;
cc._RF.pop();
}, {
...
return e = o([ u, f, h(cc.RichText), d(999), p("Localized/LocalizedRichText") ], e);
}(cc.Component);
n.default = v;
cc._RF.pop();
}, {
...
var i = t("../../Blade/Decorators/Service"), a = t("../../Blade/Decorators/Singleton"), s = function(t) {
r(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
...
for (var e = [], n = 1; n < arguments.length; n++) e[n - 1] = arguments[n];
var r = this.langs[this.curLang], o = r && r[t] || t;
e && e.length > 0 && (o = o.replace(/\{(\d+)\}/g, function(t, n) {
return n in e ? e[n] : t;
}));
return o;
};
...
return e = n = o([ a.default, i.default("LocalizedService") ], e);
}(cc.EventTarget);
(function(t) {
(function(t) {
...
var a = t("../../Services/LocalizedService"), s = cc._decorator, c = s.ccclass, u = s.property, l = s.executeInEditMode, f = s.menu, p = s.requireComponent, h = s.executionOrder, d = function() {
function t() {
this.lang = "";
...
o([ u({
serializable: !0
}), i("design:type", String) ], t.prototype, "lang", void 0);
o([ u({
type: cc.SpriteFrame,
serializable: !0
}), i("design:type", "function" == typeof (e = "undefined" != typeof cc && cc.SpriteFrame) ? e : Object) ], t.prototype, "spriteFrame", void 0);
return t = o([ c("SpriteFrameSet") ], t);
}();
n.SpriteFrameSet = d;
var v = function(t) {
r(e, t);
...
o([ u({
type: [ d ]
}), i("design:type", Array) ], e.prototype, "spriteFrameSet", void 0);
return e = o([ c, l, p(cc.Label), h(999), f("Localized/LocalizedSprite") ], e);
}(cc.Component);
n.default = v;
cc._RF.pop();
}, {
...
t.updateWidget(e);
var o = e.convertToWorldSpaceAR(cc.Vec2.ZERO), i = r.convertToNodeSpaceAR(o), a = cc.v2(i.x, i.y + e.height / 2).sub(cc.v2(i.x, n.height / 2)).mag(), s = a / n.height, c = cc.v2(i.x - e.width / 2, i.y).sub(cc.v2(-n.width / 2, i.y)).mag(), u = c / n.width, l = e.width, f = l / n.width, p = e.height;
return {
top: a,
left: c,
width: l,
...
type: cc.Node,
tooltip: "等待指示图标"
}), i("design:type", "function" == typeof (n = "undefined" != typeof cc && cc.Node) ? n : Object) ], e.prototype, "spin", void 0);
return e = o([ u ], e);
}(cc.Component);
n.default = f;
cc._RF.pop();
...
var o = t("../../Blade/Decorators/Service"), i = t("../../Blade/Decorators/Singleton"), a = function() {
function t() {}
e = t;
t.prototype.initialize = function() {
this.list = {};
...
var o = "function" == typeof t ? this.getModel(t) : t;
if (null != o) {
for (var i = 0, a = e; i < a.length; i++) {
"string" == typeof (u = a[i]) && this.list[o.alias].event.on(u, n, r);
}
for (var s = 0, c = e; s < c.length; s++) {
var u;
"string" == typeof (u = c[s]) && this.noticeModelFieldUpdate(t, u, o[u], o[u]);
}
}
};
t.prototype.off = function(t, e, n, r) {
var o = "function" == typeof t ? this.getModel(t) : t;
if (null != o) for (var i = 0, a = e; i < a.length; i++) {
var s = a[i];
"string" == typeof s && this.list[o.alias].event.off(s, n, r);
}
};
t.prototype.noticeModelFieldUpdate = function(t, e, n, r) {
var o = "function" == typeof t ? this.getModel(t) : t;
null != o && this.list[o.alias].event.emit(e, o, e, n, r);
};
...
get: function() {
return t[e.INNER_DATA_FIELD][o];
},
set: function(r) {
var i = t[e.INNER_DATA_FIELD][o];
t[e.INNER_DATA_FIELD][o] = r;
n.noticeModelFieldUpdate(t, o, r, i);
}
});
});
...
var e;
return t = e = r([ i.default, o.default("ModelService") ], t);
}();
(function(t) {
...
for (var r = t.getPoints(e), o = t.getPoints(n), i = 0; i < r.length; i++) {
var a = r[i];
...
var r = cc.Material.createWithBuiltin("2d-gray-sprite", 0), o = t.getComponent(cc.Sprite);
o && (e ? o.setMaterial(0, r) : o.setMaterial(0, n));
for (var i = 0, a = t.getComponentsInChildren(cc.Sprite); i < a.length; i++) {
var s = a[i];
...
var i = t("../../Blade/Decorators/Singleton"), a = t("../../Blade/Decorators/Service"), s = function(t) {
r(e, t);
function e() {
return null !== t && t.apply(this, arguments) || this;
}
e.prototype.initialize = function() {};
e.prototype.lazyInitialize = function() {};
return e = o([ i.default, a.default("NotificationService") ], e);
}(cc.EventTarget);
n.default = s;
cc._RF.pop();
}, {
...
var o = t("../../Blade/Decorators/Service"), i = t("../../Blade/Decorators/Singleton"), a = t("../Platforms/WebPlatform"), s = t("../Platforms/WxPlatform"), c = t("../Platforms/QQPlatform"), u = t("../Platforms/GPPlatform"), l = function() {
function t() {}
e = t;
t.prototype.initialize = function() {
switch (this.getType()) {
...
var e;
return t = e = r([ i.default, o.default("PlatformService") ], t);
}();
(function(t) {
(function(t) {
t[t.WX = 0] = "WX";
...
"../../Blade/Decorators/Service": "Service",
"../../Blade/Decorators/Singleton": "Singleton",
"../Platforms/GPPlatform": void 0,
"../Platforms/QQPlatform": void 0,
...
var s = t("../../Blade/Decorators/Singleton"), c = t("../../Blade/Decorators/Service"), u = t("../../Blade/Interfaces/IPopup"), l = t("../Libs/Structs/PriorityQueue"), f = t("../Libs/Tween/Tween"), p = t("../Helpers/PromiseHelper"), h = function(t) {
r(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
...
var o = cc.find("Blade");
if (null == o) throw new Error("没有Blade节点");
...
}) ? Promise.reject("Panel已经在列表内") : new Promise(function(r, o) {
return i(e, void 0, void 0, function() {
var e, o, s, c, l, f, h, d, v, y = this;
...
f = c; l < f.length; l++) (h = f[l]).applyTemplate && h.applyTemplate(t.template);
e.once(n.EventType.POPUP_CLICK, function(e, o) {
return i(y, void 0, void 0, function() {
return a(this, function(i) {
switch (i.label) {
case 0:
blade.popup.emit(n.EventType.POPUP_CLICK, e, o);
o instanceof cc.Node && (o = o.getComponent(u.default));
return [ 4, o.disappear() ];
...
d = this.list.front().priority + 1;
this.list.enqueue(s, d);
return [ 3, 12 ];
...
return e = n = o([ s.default, c.default("PopupService") ], e);
}(cc.EventTarget);
(function(t) {
(function(t) {
...
for (var o = !1, i = 0; i < this.items.length; i++) if (n.priority < this.items[i].priority) {
...
this.items.forEach(function(n, r, o) {
t.call(e, n);
});
};
t.prototype.some = function(t, e) {
return this.items.some(function(n, r, o) {
return t.call(e, n);
});
};
return t;
...
return t.call.apply(t, r([ e ], n)) ? Promise.resolve() : new Promise(function(o, i) {
var a;
a = {
onTick: function() {
try {
...
for (var n = [], o = 2; o < arguments.length; o++) n[o - 2] = arguments[o];
return t.call.apply(t, r([ e ], n)) ? new Promise(function(o, i) {
var a;
a = {
onTick: function() {
try {
...
var n = e.length;
if (n <= 0) return -1;
for (var r = 0, o = 0; o < n; ++o) r += e[o];
var i = t.getInt(0, r);
for (o = n - 1; o >= 0; --o) if ((r -= e[o]) <= i) return o;
return 0;
};
return t;
}();
...
var o = t("../../Blade/Decorators/Singleton"), i = t("../../Blade/Decorators/Service"), a = t("../Libs/Structs/Stack"), s = function() {
function t() {
...
return t = r([ o.default, i.default("SceneService") ], t);
}();
n.default = s;
cc._RF.pop();
}, {
...
var i = t("./PromiseHelper"), a = function() {
function t() {}
...
this.emit(n, s);
return [ 4, i.default.waitUntil(function() {
...
var r = function() {
function t() {}
t.getSport = function(e, n, r, o) {
void 0 === n && (n = new cc.Vec3(0, -230, 0));
void 0 === r && (r = new cc.Vec3(0, 0, 0));
void 0 === o && (o = new cc.Vec3(0, 0, 0));
return new t.Sport(e, n, r, o);
};
return t;
}();
(function(t) {
...
damping: o = new cc.Vec3(o.x, o.y, o.z)
};
this.node = e;
this.info = i;
}
...
var a = parseInt(n[i]) || 0, s = parseInt(r[i]) || 0;
if (a > s) return 1;
if (a < s) return -1;
}
...
var o = t("../../Blade/Interfaces/ICommand"), i = t("../../Blade/Services/ViewService"), a = t("../../Blade/Services/ControllerService"), s = function(t) {
r(e, t);
function e() {
return null !== t && t.apply(this, arguments) || this;
}
...
for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
i.default.instance.orderViewById("UIView", "test", t[0]);
...
var i = t("../../Blade/Decorators/Singleton"), a = t("../../Blade/Decorators/Service"), s = function() {
function t() {
this._timeScale = 1;
this._pause = !1;
...
return t = o([ i.default, a.default("TickerService") ], t);
}();
n.default = s;
var c = function(t) {
r(e, t);
...
var i = t("../../Blade/Decorators/Service"), a = t("../../Blade/Decorators/Singleton"), s = t("../Libs/ArchiveServerSDK/ArchiveServerSDK"), c = function() {
function t() {
...
this.syncing = !0;
return new Promise(function(n, r) {
s.default.getTime().then(function(o) {
console.log("同步时间:", t.timeStamp, "  :  ", o);
if (Math.abs(t.timeStamp - o) > e.MAX_TIME_DIFF) {
t.timeStamp = t.lastSyncTime = o;
t.syncing = !1;
r("超出出可接受的时间差!");
} else {
t.timeStamp = t.lastSyncTime = o;
...
e.timeRemain -= t;
if (e.timeRemain <= 0) {
(r = e.callback).apply.apply(r, o([ e.thisArgs ], e.args));
e.times > 0 && --e.times;
...
t.SYNC_INTERVAL = 6e4;
t.MAX_TIME_DIFF = 6e4;
return t = e = r([ a.default, i.default("TimerService") ], t);
}();
n.default = c;
cc._RF.pop();
}, {
...
var o = t("../../Blade/Decorators/Service"), i = t("../../Blade/Decorators/Singleton"), a = t("../Libs/Tween/Tween"), s = function() {
function t() {}
t.prototype.initialize = function() {
...
return t = r([ i.default, o.default("TweenService") ], t);
}();
n.default = s;
cc._RF.pop();
}, {
...
var r = n - e._lastTime;
e._lastTime = n;
for (var o = e._tweens.concat(), i = o.length - 1; i >= 0; i--) {
var a = o[i];
...
if (0 != e) if (this._useTicks) this._runAction(this._steps[c], n, n); else if (1 == e && n < i) {
i != this.duration && this._runAction(this._steps[c], i, this.duration);
this._runAction(this._steps[c], 0, n, !0);
} else this._runAction(this._steps[c], i, n);
...
var a = t.t;
(a == i || a > o && a < i || r && a == e) && t.f.apply(t.o, t.p);
};
...
r = this._target[s];
if (n = e._plugins[s]) for (o = 0, i = n.length; o < i; o++) r = n[o].init(this, s, r);
...
if (n = e._plugins[s]) {
a = a || {};
for (o = 0, i = n.length; o < i; o++) n[o].step && n[o].step(this, s, r, t[s], a);
}
...
return e = o([ f, c.default("UIController") ], e);
}(s.default));
n.default = p;
cc._RF.pop();
}, {
...
var c = t("../Models/GameModel"), u = t("../../Blade/Interfaces/IView"), l = t("../../Blade/Decorators/View"), f = t("../../Blade/Services/CommandService"), p = t("../Commands/TestCommand"), h = t("../../Blade/Helpers/BigHelper"), d = cc._decorator, v = d.ccclass, y = d.property, g = function(t) {
r(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.label = null;
...
console.log(h.default.toFormat("123456789987654321.123456789"));
console.log(h.default.toSmall("123456789987654321.123456789"));
};
e.prototype.onUnRegister = function() {
...
e.prototype.onTick = function(t) {};
var n, u;
o([ y(cc.Label), i("design:type", "function" == typeof (n = "undefined" != typeof cc && cc.Label) ? n : Object) ], e.prototype, "label", void 0);
o([ y(cc.Button), i("design:type", "function" == typeof (u = "undefined" != typeof cc && cc.Button) ? u : Object) ], e.prototype, "button", void 0);
return e = o([ v, l.default("UIView") ], e);
}(u.default);
n.default = g;
cc._RF.pop();
}, {
...
return t = r([ i.default, a.default("ViewService") ], t);
}();
n.default = s;
cc._RF.pop();
}, {
...
success: function(r) {
if (r.rawData) {
var o = JSON.parse(r.rawData), i = wx.getSystemInfoSync();
e.userInfo = {
avatar: o.avatarUrl || "",
nickname: o.nickName || "",
gender: o.gender || 0,
...
var o = function(o) {
if (o.rawData) {
var i = JSON.parse(o.rawData), a = wx.getSystemInfoSync();
e.userInfo = {
avatar: i.avatarUrl || "",
nickname: i.nickName || "",
gender: i.gender || 0,
...
var i = t("../../Helpers/SocketHelper"), a = t("../../Helpers/PromiseHelper"), s = t("../../Helpers/RandomHelper"), c = t("../../Helpers/HttpHelper"), u = function() {
function t() {}
...
switch (c.label) {
case 0:
t.io || (t.io = i.default.createSocket("WxServerSDK"));
...
t.io.on(i.default.EventType.CONNECT, function() {
return r(s, void 0, void 0, function() {
var r;
return o(this, function(o) {
switch (o.label) {
...
t.io.on(i.default.EventType.DISCONNECT, function() {
return r(s, void 0, void 0, function() {
return o(this, function(e) {
t.isInit = !1;
return [ 2 ];
...
return t.io.getStatus() != i.default.LinkStatus.EMPTY;
}) ];

case 1:
l.sent();
t.io.getStatus() == i.default.LinkStatus.SUCCEED ? c() : u();
return [ 2 ];
}
});
});
...
switch (o.label) {
case 0:
if (!t.io || t.io.getStatus() != i.default.LinkStatus.SUCCEED) return [ 3, 3 ];
a = (r = t).emitSync;
s = [ t.EventType.LOGIN ];
return [ 4, t.getLoginInfo(e, n) ];

case 1:
return [ 4, a.apply(r, s.concat([ o.sent() ])) ];
...
user_id: t.userId,
sys_app_id: t.sysId,
share_place_arr: i.map(function(t) {
return t.place_id;
})
};
...
user_id: t.userId,
sys_app_id: t.sysId,
place_id: i[0].place_id,
clerk_id: i[0].clerk_id,
time: n
};
s = "clickSharePlace";
}
...
t.recordVideo = function(e, n, i, s) {
return r(this, void 0, void 0, function() {
var r, c, u = this;
return o(this, function(o) {
switch (o.label) {
...
return r(this, void 0, void 0, function() {
var r, i, a, s, c, u, l, f, p, h, d, v, y, g, m, _, b, S, w;
return o(this, function(o) {
switch (o.label) {
case 0:
...
a.referrerInfo && a.referrerInfo.appId && (d = a.referrerInfo.appId);
...
S = parseInt(m.shareTime);
_ = parseInt(w.place_id);
b = parseInt(w.clerk_id);
}
r = {
code: s,
app_id: e,
