...
declare const wx: {
	...
	createInterstitialAd(Option: { adUnitId: string }): InterstitialAd;

	openCustomerServiceConversation(option?: any);

	/**
	 *
	 * 游戏圈
	 * @param {*} any
	 * @returns {{ destroy(); hide(); show(); onTap(); offTap() }}
	 */
	 ...
	 * 监听WebSocket 连接打开事件
	 */
	onSocketOpen(callback: (header: object) => void): void;
	/**
	 * 监听WebSocket 连接关闭事件
	 */
	onSocketClose(callback: (res) => void): void;
	/**
	 * 监听WebSocket 接受到服务器的消息事件
	 */
	onSocketMessage(callback: (data: { data: string }) => void): void;
	/**
	 * 监听WebSocket 错误事件
	 */
	onSocketError(callback: (e) => void): void;
	/**
	...
	updateShareMenu(object: {
		withShareTicket: boolean;
		success: (res: any) => void;
		fail: (res: any) => void;
		complete: (res: any) => void;
	}): void;
	setEnableDebug(object: {
		enableDebug: boolean;
		success: (res: any) => void;
		fail: (res: any) => void;
		complete: (res: any) => void;
	 ...
	 * 向子域发消息
	 */
	postMessage(object: { type: number; rank_type?: string; key_list?: Array; set_data?: Array });
	/**
	 * 参数
	 */
...
declare interface SocketTask {
	 ...
	 * 监听WebSocket 连接打开事件
	 */
	onOpen(callback: (header: object) => void): void;
	/**
	 * 监听WebSocket 连接关闭事件
	 */
	 ...
	 * 监听WebSocket 接受到服务器的消息事件
	 */
	onMessage(callback: (data: { data: string }) => void): void;
	/**
	 * 通过 WebSocket 连接发送数据
	 */
	send(object: {
